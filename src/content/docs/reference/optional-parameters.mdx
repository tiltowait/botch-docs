...
<Picture src={optionsHidden} alt="Optional parameters are hidden by default" />

**After tabbing or clicking "more":**

<Picture src={optionsExpanded} alt="Tabbing or clicking 'more' shows optional parameters" />
...
<Picture src={charSelect} alt="The character selector means you don't have to use the character option" />
