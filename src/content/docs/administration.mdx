...
* [`/roll`](/reference/rolls): Perform a roll on a player's behalf.
* [`/character display`](/reference/characters): View a character's stats.
* [`/traits list`](/reference/traits): View a character's Traits and Specialties.
