...
<Tabs syncKey="bot">
  ...
  <Picture src={botchRollBasic} width={imgWidth} alt="Botch: Basic roll" />
  </TabItem>
  ...
  <Picture src={beatRollBasic} width={imgWidth} alt="Beat: Basic roll" />
...
<Tabs syncKey="bot">
  ...
  <Picture src={botchRollWillpower} width={imgWidth} alt="Botch: Willpower roll" />
  ...
  <Picture src={botchRollWillpower} width={imgWidth} alt="Beat: Willpower roll" />
...
<Tabs syncKey="bot">
  ...
  <Picture src={botchRollSpecs} width={imgWidth} alt="Botch: Roll with Specialties" />
  </TabItem>
  <TabItem label="Beat (CofD)">
  ...
  <Picture src={beatRollSpecs} width={imgWidth} alt="Beat: Roll with Specialties" />
  </TabItem>
</Tabs>
...
<Picture src={ambiguousTrait} width={imgWidth} alt="Ambiguous traits cannot be rolled" />
