...
banner:
  content: |
    The examples on this page show required parameters only. <a href="/reference/traits" title="Traits Reference">See full documentation.</a>
---
