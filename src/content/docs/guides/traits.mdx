...
```
/traits assign traits:Foo=1; Bar=2; Baz=3
```
...
```
/traits remove traits:Foo; Bar; Baz
```
...
```
/specialties assign specialties:Foo=Spec,Another Spec; Bar=Yet Another Spec
```
...
```
/specialties remove specialties:Foo=Spec,Another Spec; Bar=Yet Another Spec
```
