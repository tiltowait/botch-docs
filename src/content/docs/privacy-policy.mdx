...
**Botch** obviously stores any data you put into your character, such as name, profile, Custom Traits, etc., as well as any [images you upload as a premium user](/guides/premium).
...
"Log data" is always frustratingly vague. In the interest of transparency, here are real some real examples pulled from the database, without redaction. Plus, I enjoy seeing the technical details underpinning the applications I use; maybe someone else will find this interesting.
